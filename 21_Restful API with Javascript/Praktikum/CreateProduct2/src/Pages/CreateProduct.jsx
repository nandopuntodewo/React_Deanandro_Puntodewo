...
export default function Form() {
  ...
  async function fetchData() {
    try {
      const result = await axios.get("https://651e992e44a3a8aa4768a55d.mockapi.io/api/v1/products");
  ...
  async function handleDelete(index) {
    try {
      const url = `https://651e992e44a3a8aa4768a55d.mockapi.io/api/v1/products/${index + 1}`;
  ...
  function handleEdit(index) {
    ...
    reset({
      ...
      adittionalDescription: productToEdit.productDesc,
    });
  ...
  const onSubmit = async (data) => {
    try {
      if (editIndex !== null) {
        const url = `https://651e992e44a3a8aa4768a55d.mockapi.io/api/v1/products/${editIndex + 1}`;
        const response = await axios.put(url, data);
        console.log(response)
        alert("Data Updated");
        fetchData();
    } else {
      const response = await axios.post("https://651e992e44a3a8aa4768a55d.mockapi.io/api/v1/products", data);
